...
AGENT_NAME="Bengt"  # Your agent's name
WORKSPACE="/root/tbrain"  # Your workspace path
REPO_OWNER="theolundqvist"  # Your GitHub username
REPO_NAME="tbrain"  # Your workspace repo name
